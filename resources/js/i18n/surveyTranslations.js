...
export const TRANSLATIONS = {
    ja: {
        ...
        fishQuestions: [
            ...
            '色合い',
            '身質・食感',
            '調理のしやすさについて、どのように評価されますか？',
            '今回の試食を通じて、冷凍魚に対するイメージは変わりましたか？',
            '今後、使用してみたい・興味のある魚種を教えてください。（複数選択可）',
            '希望する納品状態を教えてください。',
            '今後、今回の商品を取り扱うことについて、どのようにお考えですか？',
            '今後のご案内について、ご希望があればお選びください。（複数選択可）',
            '商品や納品方法について、ご意見・ご要望があればお聞かせください。',
        ],
    ...
    en: {
        ...
        fishQuestions: [
            ...
            'Color',
            'Texture',
            'How would you rate the ease of cooking?',
            'Has your impression of frozen fish changed through this tasting?',
            'Which fish species would you like to use, or are you interested in, going forward? (multiple selections allowed)',
            'Please tell us your preferred delivery condition.',
            'What are your thoughts on carrying this product going forward?',
            'Please select any follow-up information you would like. (multiple selections allowed)',
            'Please share any comments or requests regarding the product or delivery method.',
        ],
        fishOptions: {
            '非常に良い': 'Very good',
            '良い': 'Good',
            ...
            '調理していないため分からない': 'Not sure, have not cooked it yet',
            '大きく良くなった': 'Improved a lot',
            '良くなった': 'Improved',
            '悪くなった': 'Got worse',
            '穴子': 'Conger eel (Anago)',
            'シマアジ': 'Striped jack (Shimaaji)',
            '冷凍状態で納品し、自店で解凍': 'Delivered frozen, thawed at our store',
            '現地で適切に解凍し、チルド状態で納品': 'Properly thawed on-site and delivered chilled',
            'どちらでもよい': 'Either is fine',
            '今後検討したい': 'Would like to consider it going forward',
            '見積りを希望する': 'Would like a quote',
            '商品・価格について詳しい説明を希望する': 'Would like a detailed explanation about the product and pricing',
            '商談を希望する': 'Would like a business meeting',
            '現時点では希望しない': 'Not interested at this time',
            'その他': 'Other',
            'レストラン': 'Restaurant',
            'ホテル': 'Hotel',
            '輸入業': 'Importer',
